	...
	<div class="search_page">
		<div class="h_layout">
			...
			<header class="top_bar">
              ...
              placeholder="搜索" v-model="text" @input="goSearch">
              <!-- <input type="search" class="goods_search_content" 
              placeholder="搜索" v-model="text" @keyup.enter="goSearch"> -->
					</form>
				...
				<main class="main_goods_box">
					<ul>
						<li class="goods_item" v-for="(item,i) in searchData" :key="i">
...
export default {
  ...
  methods:{
    ...
    goSearch(){
      if(this.text =='') return;
      this.$http.get('/search',{params:{kw:this.text}}).then(res=>{   //http://127.0.0.1:3333/detail?mId=6
        console.log(res);
